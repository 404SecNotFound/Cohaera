...
25 documents, about 98,000 words. This page exists so you never have to
...
| [EXTERNAL-RESULTS](EXTERNAL-RESULTS.md) | It was finally run against somebody else's data. What happened? Zero detections across 375 attack sessions, and three measurements showing why the corpus and the detector do not measure the same thing. |
