...
31 documents, about 113,000 words. This page exists so you never have to
...
| [EXTERNAL-RESULTS](EXTERNAL-RESULTS.md) | It was finally run against somebody else's data. What happened? Zero detections across 375 attack sessions, and a computed bound on what any structure-reading detector could have scored here. |
...
| [NOTICES](NOTICES.md) | What is the `cohaera_notice` alert stream, what does `notice_grade` mean, and why is a critical finding not always a page? |
